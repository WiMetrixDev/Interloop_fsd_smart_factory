...
{
    class upload_style_bulletin_model
    {
        ...
        public upload_style_bulletin_model(String Order, String Style,String Article,String Operation_ID,String Operation_Description,String SMV,String PieceRate,String opsequence,String status)
        {
            this.Order          = Order;
            this.Style          = Style;
