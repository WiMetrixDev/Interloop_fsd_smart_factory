...
namespace Wimetrix_warehouse_mangement_system.Warehouse_Management.Manual_Stocking.Stock_Out
{
    class stock_out_model
    {
        ...
        public stock_out_model(bool Select, String Order, String Roll_ID, String Color, String Weight, String vendor, String fabric_lot, String fabric_type,String location)
        {
            this.Select = Select;
            this.Order = Order;
